...
export enum USBDescriptorType {
	// USB 2.0 Specification, Revision 2.0, 9.4 "Standard Device Requests", Table 9-5 "Descriptor Types"
	DEVICE = 1,
	CONFIGURATION = 2,
	STRING = 3,
	INTERFACE = 4,
	...
	// On-The-Go and Embedded Host Supplement to the USB Revision 2.0 Specification, Revision 2.0, version 1.1a, 6.1 "OTG Descriptor" Table 6-1 "OTG Descriptor"
	...
	// Interface Association Descriptors Engineering Change Notice, Specification Changes, Amendments to Table 9-6.
